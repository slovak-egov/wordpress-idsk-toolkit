<?php
    ...
    function idsktk_gov_register_block_hidden () {
        ...
        acf_register_block( [
                                ...
                                'description'     => __( 'Skrytý text (zobrazenie na požiadanie)', 'idsk-toolkit' ),
                                'render_callback' => 'idsktk_render_callback_hidden',
                                'category'        => 'gov-blocks',
    ...
    add_action( 'acf/init', 'idsktk_gov_register_block_hidden' );

    function idsktk_render_callback_hidden ( $block ) {
        set_query_var( 'block', $block );
        get_template_part( '/blocks/block-hidden/template/tmp', 'block' );
    }

    function idsktk_block_init_assets_hidden () {
        wp_enqueue_style( 'block_init_hidden', get_theme_file_uri( '/blocks/block-hidden/template/style.css' ) );
    }

    add_action( 'enqueue_block_editor_assets', 'idsktk_block_init_assets_hidden' );