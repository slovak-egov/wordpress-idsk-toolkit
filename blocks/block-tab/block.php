<?php
    ...
    function id_sk_gov_register_block_tab () {
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '1. Tab - začiatok', 'idsk' ),
                                'description'     => __( 'Tab element zoznam tabov', 'idsk' ),
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '2. Tab - otvorenie sekcie', 'idsk' ),
                                'description'     => __( 'Tab element obsah tabu otvorenie', 'idsk' ),
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '3. Tab - zatvorenie sekcie', 'idsk' ),
                                'description'     => __( 'Tab element obsah tabou ukončenie', 'idsk' ),
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '4. Tab - koniec', 'idsk' ),
                                'description'     => __( 'Tab element ukončenie', 'idsk' ),
