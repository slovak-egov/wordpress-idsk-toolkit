<?php
    ...
    function idsktk_id_sk_gov_register_block_tab () {
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '1. Tab - začiatok', 'idsk-toolkit' ),
                                'description'     => __( 'Tab element zoznam tabov', 'idsk-toolkit' ),
                                'render_callback' => 'idsktk_render_callback_tab_open',
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '2. Tab - otvorenie sekcie', 'idsk-toolkit' ),
                                'description'     => __( 'Tab element obsah tabu otvorenie', 'idsk-toolkit' ),
                                'render_callback' => 'idsktk_render_callback_tab_section_open',
                                'category'        => 'gov-blocks-tabs',
                                'icon'            => '<svg viewBox="0 -20 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m465 81.433594v-21.433594c0-33.085938-26.914062-60-60-60h-345c-33.085938 0-60 26.914062-60 60v352c0 33.085938 26.914062 60 60 60h392c33.085938 0 60-26.914062 60-60v-272c0-28.617188-20.148438-52.609375-47-58.566406zm-40-21.433594v20h-90v-20c0-7.011719-1.21875-13.738281-3.441406-20h73.441406c11.027344 0 20 8.972656 20 20zm-150-20c11.027344 0 20 8.972656 20 20v20h-91v-20c0-7.011719-1.21875-13.738281-3.441406-20zm197 372c0 11.027344-8.972656 20-20 20h-392c-11.027344 0-20-8.972656-20-20v-352c0-11.027344 8.972656-20 20-20h84c11.027344 0 20 8.972656 20 20v60h288c11.027344 0 20 8.972656 20 20zm0 0"/></svg>',
                                'mode'            => 'preview',
                                'align'           => 'full',
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '3. Tab - zatvorenie sekcie', 'idsk-toolkit' ),
                                'description'     => __( 'Tab element obsah tabou ukončenie', 'idsk-toolkit' ),
                                'render_callback' => 'idsktk_render_callback_tab_section_close',
                                'category'        => 'gov-blocks-tabs',
                                'icon'            => '<svg viewBox="0 -20 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m465 81.433594v-21.433594c0-33.085938-26.914062-60-60-60h-345c-33.085938 0-60 26.914062-60 60v352c0 33.085938 26.914062 60 60 60h392c33.085938 0 60-26.914062 60-60v-272c0-28.617188-20.148438-52.609375-47-58.566406zm-40-21.433594v20h-90v-20c0-7.011719-1.21875-13.738281-3.441406-20h73.441406c11.027344 0 20 8.972656 20 20zm-150-20c11.027344 0 20 8.972656 20 20v20h-91v-20c0-7.011719-1.21875-13.738281-3.441406-20zm197 372c0 11.027344-8.972656 20-20 20h-392c-11.027344 0-20-8.972656-20-20v-352c0-11.027344 8.972656-20 20-20h84c11.027344 0 20 8.972656 20 20v60h288c11.027344 0 20 8.972656 20 20zm0 0"/></svg>',
                                'mode'            => 'preview',
                                'align'           => 'full',
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '4. Tab - koniec', 'idsk-toolkit' ),
                                'description'     => __( 'Tab element ukončenie', 'idsk-toolkit' ),
                                'render_callback' => 'idsktk_render_callback_tab_close',
                                'category'        => 'gov-blocks-tabs',
                                'icon'            => '<svg viewBox="0 -20 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m465 81.433594v-21.433594c0-33.085938-26.914062-60-60-60h-345c-33.085938 0-60 26.914062-60 60v352c0 33.085938 26.914062 60 60 60h392c33.085938 0 60-26.914062 60-60v-272c0-28.617188-20.148438-52.609375-47-58.566406zm-40-21.433594v20h-90v-20c0-7.011719-1.21875-13.738281-3.441406-20h73.441406c11.027344 0 20 8.972656 20 20zm-150-20c11.027344 0 20 8.972656 20 20v20h-91v-20c0-7.011719-1.21875-13.738281-3.441406-20zm197 372c0 11.027344-8.972656 20-20 20h-392c-11.027344 0-20-8.972656-20-20v-352c0-11.027344 8.972656-20 20-20h84c11.027344 0 20 8.972656 20 20v60h288c11.027344 0 20 8.972656 20 20zm0 0"/></svg>',
                                'mode'            => 'preview',
                                'align'           => 'full',
    ...
    add_action( 'acf/init', 'idsktk_id_sk_gov_register_block_tab' );

    // templates
    // tab open
    function idsktk_render_callback_tab_open ( $block ) {
        set_query_var( 'block', $block );
        get_template_part( '/blocks/block-tab/template/tmp-block', 'open' );
    }

    // section open
    function idsktk_render_callback_tab_section_open ( $block ) {
        set_query_var( 'block', $block );
        get_template_part( '/blocks/block-tab/template/tmp-block-section', 'open' );
    }

    // section close
    function idsktk_render_callback_tab_section_close ( $block ) {
        set_query_var( 'block', $block );
        get_template_part( '/blocks/block-tab/template/tmp-block-section', 'close' );
    }

    // tab close
    function idsktk_render_callback_tab_close ( $block ) {
        set_query_var( 'block', $block );
        get_template_part( '/blocks/block-tab/template/tmp-block', 'close' );
    }

    // init assets
    function idsktk_block_init_assets_tab () {
        wp_enqueue_style( 'block_init_tab', get_theme_file_uri( '/blocks/block-tab/template/style.css' ) );
    }
    add_action( 'enqueue_block_editor_assets', 'idsktk_block_init_assets_tab' );