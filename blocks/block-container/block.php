<?php
    ...
    function id_sk_gov_register_block_container () {
        ...
        acf_register_block( [
                                ...
                                'title'           => __( 'Kontainer - začiatok', 'idsk' ),
                                'description'     => __( 'Otvorenie kontajneru pre template bez kontajneru', 'idsk' ),
        ...
        acf_register_block( [
                                ...
                                'title'           => __( 'Kontainer - koniec', 'idsk' ),
                                'description'     => __( 'Ukončenie kontajneru pre template bez kontajneru', 'idsk' ),
