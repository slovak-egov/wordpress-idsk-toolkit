<?php
    ...
    function id_sk_gov_register_block_grid () {
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '1. Row začiatok', 'idsk' ),
                                'description'     => __( 'Otvorenie Row bloku', 'idsk' ),
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '4. Row koniec', 'idsk' ),
                                'description'     => __( 'Ukončenie Row bloku', 'idsk' ),
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '2. Col sekcia otvorenie', 'idsk' ),
                                'description'     => __( 'Otvorenie bloku s Col', 'idsk' ),
        ...
        acf_register_block( [
                                ...
                                'title'           => __( '3. Col sekcia ukončenie', 'idsk' ),
                                'description'     => __( 'Ukončenie bloku s Col', 'idsk' ),
