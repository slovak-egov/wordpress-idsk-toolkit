        ...
        <div class="idsk-interactive-map__header">
                    ...
                    <div class="govuk-form-group">
                        <div class="govuk-radios govuk-radios--inline">
                            <div class="govuk-radios__item idsk-intereactive-map__radio-map">
                                ...
                                <label class="govuk-label govuk-radios__label" for="interactive-radios-b-1"><?php echo __( 'Mapa', 'idsk-toolkit' ) ?></label>
                            </div>
                            <div class="govuk-radios__item idsk-intereactive-map__radio-table">
                                ...
                                <label class="govuk-label govuk-radios__label" for="interactive-radios-b-2"><?php echo __( 'Tabuľka', 'idsk-toolkit' ) ?></label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php if (count($indicatorOptions) > 0) { ?>
                <h3 class="govuk-heading-m">
                    <span class="idsk-interactive-map__current-indicator"></span> <?php echo __( 'za', 'idsk-toolkit' ) ?> <span class="idsk-interactive-map__current-time-period"><?php echo __( 'celé obdobie', 'idsk-toolkit' ) ?></span>
                </h3>
            <?php } ?>
        </div>
