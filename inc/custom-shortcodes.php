...
class IdskShortcodes
{
    ...
    public function idskstats($attributes = [])
    {
        $item = isset($attributes['item']) ? $attributes['item'] : '';

        $data = $this->data('idskstats', $item);
        ...
        return '<!-- REPLACE:idskstats-' . $item . ' -->' . $value . '<!-- /REPLACE -->';
    }
    ...
    public function idskmedians($attributes = [])
    {
        $limit = isset($attributes['limit']) ? (int)$attributes['limit'] : null;

        $medians = $this->data('idskmedians');
        $content = '';
        ...
        return '<!-- REPLACE:idskmedians -->' . $content . '<!-- /REPLACE -->';
    }
}

add_shortcode('idskstats', [IdskShortcodes::getSingleton(), 'idskstats']);
add_shortcode('idskmedians', [IdskShortcodes::getSingleton(), 'idskmedians']);
add_shortcode('safecountries', [IdskShortcodes::getSingleton(), 'safecountries']);